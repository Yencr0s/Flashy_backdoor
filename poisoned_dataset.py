...
# def create_defense_data_loader(args):
    ...
    #     dataset=train_data_ori, batch_size=args.batch_size, shuffle=True, num_workers=2)
    # test_data_ori_loader = DataLoader(
    #     dataset=test_data_ori, batch_size=args.batch_size, shuffle=False, num_workers=2)
    # test_data_tri_loader = DataLoader(
    #     dataset=test_data_tri, batch_size=args.batch_size, shuffle=False, num_workers=2)
...
def create_backdoor_data_loader_adaptive(args):
    ...
    clean_trainloader = DataLoader(
        dataset=clean_trainset, batch_size=args.batch_size, shuffle=True, num_workers=2)
    bk_trainloader = DataLoader(
        dataset=bk_trainset, batch_size=args.batch_size, shuffle=True, num_workers=2)
    test_data_ori_loader = DataLoader(
        dataset=test_data_ori, batch_size=args.batch_size, shuffle=False, num_workers=2)
    test_data_tri_loader = DataLoader(
        dataset=test_data_tri, batch_size=args.batch_size, shuffle=False, num_workers=2)
